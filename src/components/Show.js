...
export default function Show(){
    ...
    function Deletefun (email) {
        axios.delete("https://https://jfsd-spring-hosting-production-b726.up.railway.app//delete", {params:{
            email: email
        }}).then((res)=>{
            alert(res.data);
            setResult(null)
    ...
    function saveEdit() {
        axios.put("https://https://jfsd-spring-hosting-production-b726.up.railway.app//update", {
    ...
    if(result == null) {
        axios.get("https://https://jfsd-spring-hosting-production-b726.up.railway.app//all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
